...
fare_settings$fare_per_mode[mode == "BUS", allow_same_route_transfer := FALSE]
```
...
access_300 <- calculate_accessibility(fare_settings, 300)
access_500 <- calculate_accessibility(fare_settings, 500)
access_900 <- calculate_accessibility(fare_settings, 900)
```
