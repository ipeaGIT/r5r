...
Sometimes, we want to know more than simply the total travel time from A to B. You want to know more information about each route. This is the when the `expaded_travel_time_matrix()` function comes in.

how many transfers that trip required, or how much was spent walking, waiting for the public transport and traveling inside the vehicle.
