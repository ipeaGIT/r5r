...
# 2. Changing LTS values

The approaches to changing LTS are pretty similar to changing road speeds. It can 
be done either with a `data.frame` indicating the new LTS of each individual OSM edge id, or an `sf data.frame` polygon that will update the LTS of all the roads that fall within each polygon.
