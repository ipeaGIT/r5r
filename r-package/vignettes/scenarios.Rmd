...
urlcolor: blue
vignette: >
  %\VignetteIndexEntry{Using custom OSM car speeds and LTS} 
...
Alternatively, we can pass a `sf` linestring of the roads where we want to 
