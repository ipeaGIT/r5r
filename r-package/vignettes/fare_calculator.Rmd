...
Now that our `fare_settings` is complete, we can use it to calculate travel time matrices and accessibility while accpouting for monetary cost cutoffs. Let's see how it's done in the next sections.
...
???
example with a pareto frontier showing the trade-offs between time and monetary costs of multiple trip alternatives.
