context("Arrival travel time matrix function")
...
default_tester <- function(r5r_core,
                           ...
                           mode = "TRANSIT",
                           arrival_datetime = as.POSIXct("13-05-2019 14:00:00",
                                                           format = "%d-%m-%Y %H:%M:%S"),
                           breakdown = FALSE,
                           max_walk_time = Inf,
                           max_bike_time = Inf,
  ...
  results <- arrival_travel_time_matrix(
    r5r_core,
    origins = origins,
...
test_that("adequately raises errors", {
  ...
  expect_error(default_tester(r5r_core, arrival_datetime = "13-05-2019 14:00:00"))
