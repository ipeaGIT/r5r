...
test_that("tobler_hiking", {
  ...
  expect_identical( round(tobler_hiking(1)), 33)
...
test_that("apply_elevation", {
  ...
  expect_silent( apply_elevation(r5r_core, raster_poa) )
  expect_silent( apply_elevation(r5r_core, c(raster_poa,raster_poa)) )

  expect_error( apply_elevation('bananas', raster_poa) )
  expect_error( apply_elevation(r5r_core, 'bananas') )
