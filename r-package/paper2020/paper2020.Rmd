...
ggplot(plot_data) + 
   geom_point(aes(id, travel_time, color = percentil), alpha = 0.1, size = 1) + 
   theme_minimal() +
   theme(axis.title.x = element_blank(), axis.text.x = element_blank())
```

Notice that the leftmost origin/destination pairs do not exhibit any variation in the distribution of their travel time along the time window. This is because the trips between such pairs rely solely on walking to be completed, therefore are not susceptible to transit reliability issues.
