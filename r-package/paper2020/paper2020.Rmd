...
`street_network_to_sf()` function that extracts the OSM street network used in 
the routing as a `sf` object and can be used to provide geographic context for 
the visualization.
