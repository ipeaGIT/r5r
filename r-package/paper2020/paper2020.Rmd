...
A sample of the Porto Alegre dataset, which will be used in the examples of this paper, is presented below:
...
dit$facet_labels <- paste0("Alternative #", dit$option)
