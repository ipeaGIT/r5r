...
of open source routing models [@lovelace2019stplanr; @padgham2019dodgr], most
options available only return the fastest route option between a set of origins 
and destinations. This simple approach overlooks how often people's actual route 
choices deviate from shortest travel time paths due to imperfect information, 
monetary costs and safety issues among other reasons [@larsen2011travel;
