...
#> [13] curl_7.0.0         proxy_0.4-29       tibble_3.3.0       fansi_1.0.7       
#> [17] sfheaders_0.4.5    pkgconfig_2.0.3    KernSmooth_2.23-26 data.table_1.18.0 
#> [21] checkmate_2.3.3    RColorBrewer_1.1-3 S7_0.2.1           desc_1.4.3        
#> [25] lifecycle_1.0.5    compiler_4.5.2     farver_2.1.2       brio_1.1.5        
#> [29] textshaping_1.0.4  fontawesome_0.5.3  class_7.3-23       htmltools_0.5.9   
...
#> [53] magrittr_2.0.4     e1071_1.7-17       withr_3.0.2        scales_1.4.0      
#> [57] backports_1.5.0    rappdirs_0.3.3     rmarkdown_2.30     otel_0.2.0        
#> [61] askpass_1.2.1      ragg_1.5.0         memoise_2.0.1      evaluate_1.0.5    
#> [65] knitr_1.51         testthat_3.3.1     s2_1.1.9           rlang_1.1.6       
#> [69] isoband_0.3.0      Rcpp_1.1.0         downlit_0.4.5      glue_1.8.0        
#> [73] DBI_1.2.3          xml2_1.5.1         rstudioapi_0.17.1  jsonlite_2.0.0    
#> [77] R6_2.6.1           rJavaEnv_0.3.0     units_1.0-0        systemfonts_1.3.1 
#> [81] fs_1.6.6          
#> 
```
